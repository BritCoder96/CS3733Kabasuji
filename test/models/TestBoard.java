...
public class TestBoard extends TestCase {
	public void testBoard () {
		...
		Square square15 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(0,2));
		Square square16 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(1,2));
		Square square17 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(2,2));
		Square square18 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(1,1));
		Square square19 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(1, 3));
		Square square20 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(2,3));
		Square square21 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(3,3));
		Square square22 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-1,0));
		Square square23 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(0,-1));
		Square square24 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-1,-1));
		Square square25 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(-1,-2));
		Square square26 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-2,-1));
		Square square27 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(-2,-2));
		Square square28 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-3, -3));
		Square square29 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(-1,-3));
		Square square30 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-3,-1));
		Square square31 = new Square(16777215, SquareTypes.BOARDSQUARE, null, new Coordinate(-2,-3));
		Square square32 = new Square(0, SquareTypes.BOARDSQUARE, null, new Coordinate(-3,-2));
